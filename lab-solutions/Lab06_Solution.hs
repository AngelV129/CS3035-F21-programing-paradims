...
{-
Q4 [2 POINTS]:
Write a function named $butLast$ (with type $[a] -> a$) that takes a list $xs$
and returns the last but one element of the list $xs$ (i.e., the second
last element).

Assumption:
(1) the input list $xs$ contains at least two elements
...
e.g. $elementAt "haskell" 5$ returns 'e'
-}
elementAt :: [a] -> Int -> a
-- YOUR CODE START HERE
