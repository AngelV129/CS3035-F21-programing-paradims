...
-- YOUR CODE START HERE
byPi a xs = [ multPi  | x <-xs, let multPi = (3.14159265359 * a) * x ]
-- YOUR CODE END HERE
...
findPrev n (x:y:xs) = if n == head xs then x else findPrev n (y:xs)
-- YOUR CODE END HERE
...
{-
Q5 [4 POINTS]:
Implement the SELECTION SORT algorithm (://www.ghttpseeksforgeeks.org/selection-sort/).
